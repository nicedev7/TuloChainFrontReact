...
const StructureSection = (props) => {
  ...
  const tilesData = [
    {
      description: '4% of the trading fees is structured by the smart contract to directly go as LP and a treasury function add-on to BNB, which enables price support linked to auto liquidity pool action. The embedded treasury add-on function feature, in the smart contract allows a price support process through the indirect addition of BNB only to existing liquidity as well as adding an LP pair of BNB/ERA.'
    },
    {
      description: '2% of trading fees goes towards an enhanced buy back protocol, as explained in Automated Price Support Feature section, the ERADEX solutions has a buy back price tracking solution where the smart contract buys back ERA tokens and auto burns anytime the price drops below 30% of the ATH price. The smart contract implements a chain of buy back by using 20% of available buy back funds. The team can also trigger a buy back via the smart contract anytime it is required'
    },
    {
      description: '2% of the Buy and 3 % of the Sells goes back to token holders in valuable ERA tokens as rewards. The reflections for ERA are deemed valuable due to the price control and treasury add-on function built in the smart contract to support price levels.'
    },
    {
